System.register(['angular2/core', '../0-input/input.component', '../1-todo/todo.component', '../2-doing/doing.component', '../3-done/done.component', '../App/item.service'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            AppComponent = (function () {
                ...
                AppComponent.prototype.ngOnInit = function () {
                    ...
                    this._itemService.getItems().then(function (items) { return _this.todoItems = items; }); //change from Angular2.0.8 to 2.0.9
